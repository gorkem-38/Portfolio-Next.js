...
let styles = {
    ...
    gcols2: "hidd lg:grid lg:grid-cols-2 lg:mt-14 lg:hover:bg-[#5be9b9] lg:duration-300 lg:transition lg:ease-in-out lg:hover:-translate-y-3",
                    ...
                    <div className={styles.divLandingPage}>
                        <Card className={styles.divCard}>
                            ...
                            <CardBody className={styles.cardBody}>
                                ...
                                <Typography className={styles.cardTypo2}>1er projet individuel, maquettage et réalisation du site en vanilla. Hébergement du site a l&apos;aide de FileZilla</Typography>
                            </CardBody>
                        </Card>
                    </div>
                </section>
