...
let styles = {
    ...
    divFrontEndIcon: "mt-12 bg-white text-black w-5/6 h-screen border rounded-lg",
        ...
        <>
            <section className={styles.sectionLink}>
                <div className={styles.divLink}>
                    <p className='text-sm'>Ayant grandi avec Internet, j'ai commencé à utiliser des ordinateurs
